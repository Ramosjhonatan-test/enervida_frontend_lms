<template>
  <div class="max-w-[1200px] mx-auto py-20 text-center">
    <div class="glass-card p-12 rounded-[40px] border-accent-neon/10 inline-block">
      ...
      <p class="text-on-surface/40 max-w-md mx-auto font-light">
        Estamos trabajando para traerte esta funcionalidad muy pronto. Por ahora, puedes seguir gestionando tus cursos.
      </p>
      <router-link to="/admin/cursos" class="btn-premium btn-primary-neon mt-8 !inline-flex">
        Volver a Cursos
      </router-link>
    </div>
  </div>
